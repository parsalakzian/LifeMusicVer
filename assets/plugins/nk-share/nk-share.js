/*!
 * Name    : WWW.MELLATWEB.COM Share
 * Version : 1.0.0
 * Author  : _WWW.MELLATWEB.COM http://nkdev.info
 */
(function(factory) {
    'use strict';
    ...
    // WWW.MELLATWEB.COMShare instance
    var WWW.MELLATWEB.COMShare = (function() {
        var instanceID = 0;

        function WWW.MELLATWEB.COMShare(item, userOptions) {
            var _this = this;
        ...
        return WWW.MELLATWEB.COMShare;
    }());

    WWW.MELLATWEB.COMShare.prototype.onClickInit = function() {
        var self = this;
        ...
        for (k; k < len; k++) {
            if (typeof options === 'object') {
                if(!items[k].nkshare) {
                    ...
                    // init
                    items[k].nkshare = new WWW.MELLATWEB.COMShare(items[k], thisOpts);
                }
            }
            else {

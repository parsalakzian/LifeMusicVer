...
## [Descargar la última versión](https://github.com/parsalakzian/LifeMusic/releases)

## Licencia

LifeMusic está licenciado bajo la licencia libre [GNU GPL v3.0](https://github.com/parsalakzian/LifeMusic/blob/main/LICENSE). Eso significa que puede redistribuir y/o modificar el proyecto bajo los terminos descritos en la Licencia Pública General de GNU v3.0 tal cual lo publica la Free Software Foundation.<br>
...
4. (Opcional) Puede configurar su propia base de datos para la aplicación o utilizar la predeterminada. Para configurar su propia base de datos, siga [éstas instrucciones](https://github.com/parsalakzian/LifeMusic/wiki/Set-up-your-own-Firebase-Database).

## Contribuciones

Las contribuciones son bienveenidas, Por favor lea los [lineamientos de contribución](https://github.com/parsalakzian/LifeMusic/blob/main/CONTRIBUTING.md) antes de contribuir.
...
Para leer el historial de cambios completo, visite [la wiki](https://github.com/parsalakzian/LifeMusic/wiki/Changelog)
